...
export default function OverMenuHeader() {
    return (
        <>
            <header
                className="header header_separate header_flowing"
                style={{
                    margin: "0px",
                    padding: "0px",
                    outline: "none",
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                className="mobile-menu-btn mobile-menu-btn_opened"
                                style={{
                                    margin: "0px",
                                    outline: "none",
                                    boxShadow: "none",
                        ...
                        >
                            <div
                                className="desktop-menu-btn desktop-menu-btn_opened"
                                style={{
                                    margin: "0px",
                                    padding: "0px",
                                    outline: "none",
