...
export default function Bottom() {
    return (
        <>
            <div
                className="py-10 flex max-sm:flex-col justify-center items-center gap-[30px] max-sm:py-[30px]"
                style={{
                    margin: "0px",
                    padding: "0px",
                    outline: "none",
            ...
            >
                ...
                >
                    ...
                    >
                        <a
                            className="social-btn social-btn_dark-hover"
                ...
                <p
                    className="text-xs leading-[18px] md:text-base md:leading-6 text-white text-opacity-60 text-center max-sm:text-base max-sm:leading-6"
                    style={{
                        padding: "0px",
                        outline: "none",
                        boxShadow: "none",
