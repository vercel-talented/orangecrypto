...
export default function OverMenuFooter() {
    return (
        <>
            <div
                className="py-10 flex max-sm:flex-col justify-center items-center gap-[30px]"
                style={{
                    margin: "0px",
                    padding: "0px",
                    outline: "none",
            ...
            >
                ...
                <p
                    className="text-xs leading-[18px] md:text-base md:leading-6 text-white text-opacity-60 text-center"
                    style={{
                        padding: "0px",
                        outline: "none",
                        boxShadow: "none",
